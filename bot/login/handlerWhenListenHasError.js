...
module.exports = async function ({ api, threadModel, userModel, dashBoardModel, globalModel, threadsData, usersData, dashBoardData, globalData, error }) {
        ...
        // Auto-restart the process on fatal MQTT error
        // On Replit VM deployment, the process will be automatically restarted by the platform
        log.err("handlerWhenListenHasError", "Fatal MQTT error detected, restarting bot process in 5 seconds...", error);
